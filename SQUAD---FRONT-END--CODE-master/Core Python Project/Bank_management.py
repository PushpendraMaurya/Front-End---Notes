...
class Admin:
    ...
    def LoanUser(self,loanType):
        self.connection()
        query='''select UserDetails_j.cname,UserDetails_j.contact,UserDetails_j.email, UserDetails_j.address, UserDetails_j.account_no,Loan_Table.loan_amount , Loan_Table.loan_month , Loan_Table.emi , Loan_Table.loan_status_date from UserDetails_j inner join Loan_Table on UserDetails_j.cid = Loan_Table.cid where Loan_Table.type_of_loan = %s;'''
